...
class Wing{
	...
	public function __construct(){
		...
		$bin_conf_filename=dirname(dirname(dirname(__ROOT__)))."/server_bin/{$version}/bin/config/xml/skill/wing_skill.xml";//旧路径
		$bin_conf_filename_new=dirname(dirname(dirname(dirname(__ROOT__))))."/server_bin/{$version}/bin/config/xml/skill/wing_skill.xml";//新路径
		if(is_file($bin_conf_filename)){
			...
			$this->conf_filename=__XML__.'wing_skill.xml';
		}
