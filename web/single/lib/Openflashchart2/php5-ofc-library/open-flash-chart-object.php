...
function _ofc( $width, $height, $url, $use_swfobject, $base )
{
    ...
    //$out[] = '<script type="text/javascript" src="../../../../Bin/Openflashchart2/php5-ofc-library/'. $base .'js/ofc.js"></script>';

    if( !isset( $open_flash_chart_seqno ) )
    {
        $open_flash_chart_seqno = 1;
        $out[] = '<script type="text/javascript" src="../../../../Bin/Openflashchart2/php5-ofc-library/'. $base .'js/swfobject.js"></script>';
    }
    else
    {
